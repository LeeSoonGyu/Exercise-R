...
# data_carat 7858.771의 독립변수는 data_price의 종속변수에 정(+)의 영향을 미칠 것이다.
# data_table -104.473 / data_depth -151.236 의 두 독립변수는 data_price의 종속변수에 부(-)의 영향을 미칠 것이다.
# 위 다중회귀 분석으로 각각의 독립변수가 종속변수에 영향을 미치는 관계를 볼 수 있다.